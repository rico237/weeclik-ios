...
class MotDePasseVC: UIViewController {
    ...
    @IBAction func lostPassword(_ sender: Any) {
        ...
        HelperAndKeys.showAlertWithMessage(theMessage: "Un lien pour réinitialiser votre mot de passe vous à été envoyé sur la boite mail associé à votre compte", title: "Lien envoyé", viewController: self)
    }
}
