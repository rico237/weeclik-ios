...
final class MailHelper {
    /**
     Method called to send mail to admins when an error occurs in app.
     
     Not Functioning for now
     */
    // !!!: Correct this method to actually send email
    // TODO: Correct this method to actually send email
