...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LMGeocoderSwift/LMGeocoderSwift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Segment-Flurry/Segment_Flurry.framework"
